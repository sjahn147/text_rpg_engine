# [deprecated] Dev Mode 사용자 가이드

> **Deprecated 날짜**: 2025-12-28  
> **Deprecated 사유**: 이 문서는 초기 Dev Mode 설계 가이드로, 실제 구현과 차이가 있을 수 있음. 현재는 World Editor가 Dev Mode의 역할을 대부분 수행하고 있으며, 실제 구현 상태는 코드베이스를 참조해야 함.  
> **문서 버전**: v1.0  
> **작성일**: 2025-10-18  
> **최종 수정**: 2025-10-18
